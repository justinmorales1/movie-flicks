...
const HomePage = () => {
    return (
        <Container ml={2} >
            <ImageListMainPage itemData={itemData} header="Featured Movies and Shows" columns={4} width={500} height={450}/>
            ...
            <ImageListMainPage itemData={itemData} header="Featured Movies and Shows" columns={4} width={800} height={350}/>
        </Container>
    )
}
